...
WebConfigurationManager.ConnectionStrings("MedicalCS").ConnectionString
    ...
    Private Sub getActiveUsers()
        ...
        cmd.CommandText = "Select Doctor_Id, Firstname, Lastname, Username, Profile_Pic from tblDoctor  where status=0"
    ...
    Protected Sub gvsUn_PreRender(sender As Object, e As EventArgs)

        If (gvsUn.Rows.Count > 0) Then
            'This replaces <td> with <th> and adds the scope attribute
            gvsUn.UseAccessibleHeader = True
            'This will add the <thead> and <tbody> elements
            gvsUn.HeaderRow.TableSection = TableRowSection.TableHeader
        End If
    ...
    Protected Sub lnkblock_Click(sender As Object, e As EventArgs)
        ...
        ucmd.CommandText = "update tblDoctor set status='1' Where Doctor_Id ='" & docname & "'"
