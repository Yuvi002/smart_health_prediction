...
WebConfigurationManager.ConnectionStrings("MedicalCS").ConnectionString
    ...
    Private Sub getActiveUsers()
        ...
        cmd.CommandText = "Select Patient_Id, Firstname, Lastname, Username, Profile_Pic from tblPatient  where status=1"
    ...
    Protected Sub lnkblock_Click(sender As Object, e As EventArgs)
        ...
        ucmd.CommandText = "update tblPatient set status='0' Where Patient_Id ='" & sname & "'"
