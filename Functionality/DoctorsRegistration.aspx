...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="server">
    <div class="container">
        <asp:ValidationSummary ID="ValidationSummary1" runat="server"
            HeaderText="Errors in this form are listed below"
            DisplayMode="BulletList"
            ShowMessageBox="true"
            ForeColor="Red" />
        <h1 class="text-center" style="color: aquamarine">Patient Registration</h1>
        <br />
        <br />
        <div id="leftSide">
            <fieldset>
        ...
        <fieldset>
            <asp:Button ID="btnSubmit" BackColor="Blue" ForeColor="Black" OnClick="btnSubmit_Click1"  runat="server" CssClass="btn btn-outline-primary btn-block" Text="Register" CausesValidation="false"/>
