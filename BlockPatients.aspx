<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/E-Health System.Master" CodeBehind="BlockPatients.aspx.vb" Inherits="smart_health_prediction.BlockPatients" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2>Search and block active Patients:</h2>
        </div>
    </div>
            ...
            <asp:TemplateField HeaderText="Action">
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="lnkblock" OnClick="lnkblock_Click"  CssClass="btn btn-outline-warning"
                        runat="server" CommandArgument='<%# Eval("Patient_Id") %>'>Block</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
